...
public class ScrollBarCustomUI extends BasicScrollBarUI {
    ...
    protected Dimension getMinimumThumbSize() {
        if (scrollbar.getOrientation() == JScrollBar.VERTICAL) {
            return new Dimension(10, 40); // ancho, alto mínimo del thumb vertical
        } else {
            return new Dimension(40, 10); // alto, ancho mínimo del thumb horizontal
        }
    }
    @Override
    protected void paintThumb(Graphics g, JComponent c, Rectangle r) {
        ...
        if (scrollbar.getOrientation() == JScrollBar.VERTICAL) {
            g2.fill(new RoundRectangle2D.Double(r.x + spaceX, r.y + spaceY,
                    r.width - spaceX * 2, r.height - spaceY * 2, arc, arc));
        } else {
            g2.fill(new RoundRectangle2D.Double(r.x + spaceY, r.y + spaceX,
                    r.width - spaceY * 2, r.height - spaceX * 2, arc, arc));
        }
